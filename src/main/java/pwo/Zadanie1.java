...
public class Zadanie1 {
    ...
    public static final String FILE_NAME2 = "lucseq100.txt";
    ...
    public static void main(String[] args) {
        ...
        boolean ok2 = SequenceTools.writeToFile2(new LucasGenerator(), FROM, TO, FILE_NAME2);

        if (ok2) {
            System.out.println("Wynik zapisany do pliku: " + FILE_NAME2);
        } else {
            System.out.println("Błąd");
        }
    }
